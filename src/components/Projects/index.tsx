  ...
  const projetos = [
    {
      ...
      ling: "Next.js, Styled-Components, TypeScript",
    ...
    },
    {
      ...
      ling: "JavaScript, HTML, CSS",
      link: "https://github.com/leoFagundes/Portfolio",
      demo: "https://portfolioleo-1.netlify.app/",
    },
    {
      imageName: "assets/img/projects/blackjack.png",
      name: "Black Jack Web",
      des: "Jogo de baralho conhecido como 21 ou BlackJack. Site criado com o objetivo de me aprofundar no uso de APIs públicas.",
      ling: "Next.js, Styled Components, TypeScript",
      link: "https://github.com/leoFagundes/BlackJack",
      demo: "https://black-jack-leo.vercel.app/",
    },
    {
