...
export default function SlideProject({ currentProjectIndex, currentProject, currentProjectSide, projectList, classByButtonClicked }: {
            ...
            `}>
                {projectList.map(({ imageName, name, des, ling, link, demo }, index) => (
                    <div
                        ...
                        className={`
                            ${style.item} 
                            ${index + currentProjectSide === currentProjectIndex ? style.active : style.hidden}
                        `}
                    >
                        <div className={`${style.content} ${classByButtonClicked === 'prevClicked' ? style.prevClicked : style.nextClicked}`}>
